...
--
-- Name: elements name_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: elements symbol_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: properties props_types_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT props_types_fk FOREIGN KEY (type_id) REFERENCES public.types(type_id);
